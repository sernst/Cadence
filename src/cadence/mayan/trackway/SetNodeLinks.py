...
class SetNodeLinks(NimbleScriptBase):
    """ A remote script class for setting the prev and next links for a given
        set of nodes, passed in as a list of 'nodeLinks'.  Each is a tuple
...
#_______________________________________________________________________________
    def run(self, *args, **kwargs):
        """ Sets the prev and next links for a list of 'nodeLinks' that provide
            information about the prev and next to each specified node. """
