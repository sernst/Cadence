...
Text2Pdf  makes a 7-bit clean PDF file from any input file.
...
#___________________________________________________________________________________________________ __init__
    def __init__(self, **kwargs):
        # version number
        self._version = kwargs.get('version', "1.3")
        # iso encoding flag
        self._IsoEnc = kwargs.get('isoEncode', False)
        # formfeeds flag
        self._doFFs=False
        self._progname="Text2Pdf"
        ...
        self._ifile   = kwargs.get('inputPath', '')
        self._outPath = kwargs.get('outPath', '')
        self._tab     = kwargs.get('tabWidth', 4)
        ...
        self._landscape = kwargs.get('landscape', False)
...
#___________________________________________________________________________________________________ parse_args
    def parse_args(self):
        ...
        if outfile: self._outPath = outfile
...
#___________________________________________________________________________________________________ writestr
...
#___________________________________________________________________________________________________ convert
    def convert(self):
        ...
        if self._outPath=="":
            self._outPath = os.path.splitext(self._ifile)[0] + '.pdf'

        try:
            self._ofs = open(self._outPath, 'wb')
        except IOError:
            print 'Error: Could not open file to write --->', self._outPath
            sys.exit(3)
...
#___________________________________________________________________________________________________ writeheader
...
#___________________________________________________________________________________________________ startpage
    def startpage(self):
...
#___________________________________________________________________________________________________ endpage
...
#___________________________________________________________________________________________________ writepages
    def writepages(self):
        """Write pages as PDF"""
...
#___________________________________________________________________________________________________ writerest
    def writerest(self):
        """Finish the file"""
