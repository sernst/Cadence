...
#                                                                                   C L A S S
    ...
    Usage for two graphs within a GaitPlot, width of 8 and overall height of 6 inches (hence each graph is 3
    inches high).
        gp = GaitPlot(2, 8, 6)
        ...
        gp.plotCurve(1, xs, ys)       # plot some data
        gp.save(<file>)               # save as a .png
        gp.show()                     # launch the viewer popup
    """
...
#___________________________________________________________________________________________________ loadGait
    ...
    def setPlotInterval(self, startTime, stopTime):
        ...
        print "plot startTime = %s; stopTime = %s" % (self._plotStartTime, self._plotStopTime)
